...
class ProjectICanApplyForFundScreen extends StatefulWidget {
  const ProjectICanApplyForFundScreen({Key? key}) : super(key: key);

  @override
  State<ProjectICanApplyForFundScreen> createState() => _ProjectICanApplyForFundScreenState();
}

class _ProjectICanApplyForFundScreenState extends State<ProjectICanApplyForFundScreen> {
  ...
  void initState() {
    ...
    _dataSource = DataSource(
      onApplyForFundButtonPressed: (data) => GoRouter.of(context).go('${RouteUri.requestforaprojectfund}?projectid=${data['ProjectID']}'),
...
class DataSource extends DataTableSource {
  ...
  Future<String> getTheProjectFundAppliedOrNot(int projectID) async {
    final responseBody = await ApiService.checkProjectFundAppliedOrNot(projectID);
    String projectRequestFundCheck = responseBody['ProjectRequestFundCheck'];
