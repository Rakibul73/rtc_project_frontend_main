...
class RequestForAProjectFundScreen extends StatefulWidget {
  final String projectID;

  const RequestForAProjectFundScreen({
    Key? key,
    required this.projectID,
  }) : super(key: key);

  @override
  State<RequestForAProjectFundScreen> createState() => _RequestForAProjectFundScreenState();
}

class _RequestForAProjectFundScreenState extends State<RequestForAProjectFundScreen> {
      ...
      btnOkOnPress: () async {
        ...
        try {
          final fundRequestData = {
            ...
            'HonorariumOfPI': _formData.requestedHonorariumOfPI,
            'HonorariumOfCoPI': _formData.requestedHonorariumOfCoPI,
            'PiSignatureDate': _formData.piSignatureDate,
            'ChairmanOfDepartmentSignatureDate': _formData.dateOfChairmanOfTheDepartment,
            'TotalHonorarium': _formData.totalHonorarium,
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          FormBuilderTextField(
                                            name: 'requested_honorarium_of_pi',
                                            decoration: const InputDecoration(
                                              labelText: 'Requested amount for honorarium of PI',
                                              hintText: '(TK.)',
                                              border: OutlineInputBorder(),
                                              floatingLabelBehavior: FloatingLabelBehavior.always,
                                            ),
                                            validator: FormBuilderValidators.required(),
                                            onSaved: (value) => (_formData.requestedHonorariumOfPI = double.parse(value ?? '0.0')),
                                          ),
                                        ],
                                      ),
                                    ),
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          FormBuilderTextField(
                                            name: 'requested_honorarium_of_co_pi',
                                            decoration: const InputDecoration(
                                              labelText: 'Requested amount for honorarium of Co-PI',
                                              hintText: '(TK.)',
                                              border: OutlineInputBorder(),
                                              floatingLabelBehavior: FloatingLabelBehavior.always,
                                            ),
                                            validator: FormBuilderValidators.required(),
                                            onSaved: (value) => (_formData.requestedHonorariumOfCoPI = double.parse(value ?? '0.0')),
                                          ),
                                        ],
                                      ),
                                    ),
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          FormBuilderTextField(
                                            name: 'total_honorarium',
                                            decoration: const InputDecoration(
                                              labelText: 'Total honorarium of PI /Co-PI',
                                              hintText: '(TK.)',
                                              border: OutlineInputBorder(),
                                              floatingLabelBehavior: FloatingLabelBehavior.always,
                                            ),
                                            validator: FormBuilderValidators.required(),
                                            onSaved: (value) => (_formData.totalHonorarium = double.parse(value ?? '0.0')),
                                          ),
                                        ],
                                      ),
                                    ),
