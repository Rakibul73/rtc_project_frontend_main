...
class _MyRecievedFeedbackFromMonitoringCommitteeScreenState extends State<MyRecievedFeedbackFromMonitoringCommitteeScreen> {
  ...
  void initState() {
    ...
    _dataSource = DataSource(
      onViewMonitoringFeedbackPressed: (data) => GoRouter.of(context).go('${RouteUri.viewmonitoringfeedback}?projectmonitoringfeedbackid=${data['ProjectMonitoringFeedbackID']}'),
      data: [],
    );
  }
...
class DataSource extends DataTableSource {
  final void Function(Map<String, dynamic> data) onViewMonitoringFeedbackPressed;
  List<dynamic> data;

  DataSource({
    required this.onViewMonitoringFeedbackPressed,
    required this.data,
  });
          ...
          return Row(
            ...
            children: [
              Padding(
                padding: const EdgeInsets.only(right: kDefaultPadding),
                child: ElevatedButton(
                  onPressed: () => onViewMonitoringFeedbackPressed.call(data),
