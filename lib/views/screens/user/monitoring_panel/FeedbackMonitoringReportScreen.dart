...
class FeedbackMonitoringReportScreen extends StatefulWidget {
  final String monitoringReportID;

  const FeedbackMonitoringReportScreen({
    Key? key,
    required this.monitoringReportID,
  }) : super(key: key);

  @override
  State<FeedbackMonitoringReportScreen> createState() => _FeedbackMonitoringReportScreenState();
}

class _FeedbackMonitoringReportScreenState extends State<FeedbackMonitoringReportScreen> {
  ...
  Future<bool> _getDataAsync() async {
    if (widget.monitoringReportID.isNotEmpty) {
      await Future.delayed(const Duration(seconds: 1), () async {
        ...
        final monitoringReportIdAndCommitteeId = {
          'ProjectMonitoringReportID': monitoringReportID,
        ...
        if (fetchSpecificFeedbackDetail['statuscode'] == 200 && (fetchSpecificFeedbackDetail['feedback']).length != 0) {
          ...
          _formData.projectID = fetchSpecificFeedbackDetail['feedback'][0]['ProjectID'].toString();
          _formData.observation = fetchSpecificFeedbackDetail['feedback'][0]['Observation'] ?? '';
          _formData.suggestion = fetchSpecificFeedbackDetail['feedback'][0]['Suggestions'] ?? '';
          _formData.recommendation = fetchSpecificFeedbackDetail['feedback'][0]['Recommendations'] ?? '';
          _formData.endorsement = fetchSpecificFeedbackDetail['feedback'][0]['Endorsement'] ?? '';
          _formData.monitoringFeedbackFileLocation = fetchSpecificFeedbackDetail['feedback'][0]['MonitoringFeedbackFileLocation'] ?? '';
  ...
  void _goSubmitFeedback(BuildContext context) {
    AppFocusHelper.instance.requestUnfocus();

    final dialog = AwesomeDialog(
      context: context,
      dialogType: DialogType.question,
      title: "Are you sure you want to submit this feedback for this monitoring report?",
      desc: "Note: This action cannot be undone.",
      width: kDialogWidth,
      btnOkText: "Yes",
      btnOkOnPress: () async {
        // here should make a api request to submit feedback
        ...
        try {
          final feedbackData = {
            ...
            'MonitoringCommitteeUserID': userid,
            'Recommendations': _formData.recommendation,
            'PiCanViewOrNot': 0,
            'Suggestions': _formData.suggestion,
          ...
          if (responseBody['statuscode'] == 201) {
            ...
            final dialog = AwesomeDialog(
              ...
              width: kDialogWidth,
              btnOkText: 'OK',
              btnOkOnPress: () => GoRouter.of(context).go(RouteUri.monitorthereportasmonitoringcommittee),
            );
            dialog.show();
            ...
            final dialog = AwesomeDialog(
              context: context,
              dialogType: DialogType.error,
              title: "Error submitting Feedback: ${responseBody['message']}",
              width: kDialogWidth,
              btnOkText: 'OK',
              btnOkOnPress: () {},
            );
  ...
  Widget _content(BuildContext context) {
    final themeData = Theme.of(context);
    final pageTitle = 'Monitoring Report - ID: ${widget.monitoringReportID.isEmpty ? 'Unknown' : widget.monitoringReportID}';
            ...
            Padding(
              ...
              child: Card(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const CardHeader(title: "Part-B (For Monitoring Committee)", backgroundColor: Color.fromARGB(255, 139, 161, 168), titleColor: Color.fromARGB(255, 50, 39, 42)),
                    CardBody(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                                            ...
                                            children: [
                                              FormBuilderTextField(
                                                ...
                                                decoration: const InputDecoration(
                                                  hintText: 'Qualitative progress in %',
                                                  border: OutlineInputBorder(),
                                                  floatingLabelBehavior: FloatingLabelBehavior.always,
                                                ),
                                                initialValue: _formData.observation,
                                                validator: FormBuilderValidators.required(),
                                                onSaved: (value) => (_formData.observation = value ?? ''),
                                              ),
                                            ],
                                          ),
                                        ),
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              FormBuilderTextField(
                                                ...
                                                initialValue: _formData.suggestion,
                                                // validator: FormBuilderValidators.required(),
                                                onSaved: (value) => (_formData.suggestion = value ?? ''),
                                              ),
                                            ],
                                          ),
                                        ),
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              FormBuilderTextField(
                                                ...
                                                initialValue: _formData.recommendation,
                                                // validator: FormBuilderValidators.required(),
                                                onSaved: (value) => (_formData.recommendation = value ?? ''),
                                              ),
                                            ],
                                          ),
                                        ),
                                      ...
                                      child: SizedBox(
                                        ...
                                        child: Card(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              CardHeader(
                                                title: _formData.recommendation,
                                                backgroundColor: const Color.fromARGB(255, 51, 55, 56),
                                                titleColor: const Color.fromARGB(255, 238, 216, 221),
                                                showDivider: false,
                                              ),
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              FormBuilderTextField(
                                                ...
                                                initialValue: _formData.endorsement,
                                                // validator: FormBuilderValidators.required(),
                                                onSaved: (value) => (_formData.endorsement = value ?? ''),
                                              ),
                                            ],
                                          ),
                                        ),
                                ...
                                child: Padding(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      onPressed: () => _goSubmitFeedback(context),
                                      child: Row(
                                        mainAxisSize: MainAxisSize.min,
                                        crossAxisAlignment: CrossAxisAlignment.center,
                                        children: [
...
class FormData {
  ...
  String observation = '';
  String monitoringFeedbackFileLocation = '';
  String suggestion = '';
  String piCanViewOrNot = '';
  String recommendation = '';
  String endorsement = '';
  String monitoringCommitteeUserID = '';
}
