...
class ViewAllNotificationScreen extends StatefulWidget {
  const ViewAllNotificationScreen({Key? key}) : super(key: key);

  @override
  State<ViewAllNotificationScreen> createState() => _ViewAllNotificationScreenState();
}

class _ViewAllNotificationScreenState extends State<ViewAllNotificationScreen> {
  ...
  void viewAllSelfNotification() async {
    try {
      _initialSelfNotification = await ApiService.fetchAllNotifications();
      setState(() {
        ...
        Padding(
          ...
          child: Card(
            ...
            child: Column(
              ...
              children: [
                const CardHeader(
                  title: 'Notification List (Admin Mode)',
                ),
                CardBody(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                                      ...
                                      child: ElevatedButton(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            const Text("Back to your own notifications"),
                                          ],
                                        ),
                                      ),
                                    ),
