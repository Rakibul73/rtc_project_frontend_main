...
class _UserProfileScreenState extends State<UserProfileScreen> {
    ...
    final dialog = AwesomeDialog(
      ...
      btnOkOnPress: () async {
        ...
        try {
          ...
          final responseBody = await ApiService.updateTempUserDetails(int.parse(widget.userID), updatedTempUserData);
  ...
  Widget _content(BuildContext context) {
    final themeData = Theme.of(context);
    final pageTitle = 'Verified User - ID: ${widget.userID.isEmpty ? 'Invalid User-ID' : widget.userID}';
