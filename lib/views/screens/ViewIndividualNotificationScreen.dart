...
class _ViewIndividualNotificationScreenState extends State<ViewIndividualNotificationScreen> {
  ...
  void _goEditPage(BuildContext context) {
    ...
    final dialog = AwesomeDialog(
      ...
      width: kDialogWidth,
      btnOkText: "Yes",
      btnOkOnPress: () => GoRouter.of(context).go('${RouteUri.editproject}?notificationID=${widget.notificationID}'),
      btnCancelText: "No",
      btnCancelOnPress: () {},
    );
    dialog.show();
  ...
  Widget _content(BuildContext context) {
    ...
    final pageTitle = 'Project - ID: ${widget.notificationID.isEmpty ? 'New Project' : widget.notificationID}';
